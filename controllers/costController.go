...
func GetTenantCPUCostSum(c *fiber.Ctx) error {
...
func GetTenantMemoryCostSum(c *fiber.Ctx) error {
...
func GetTenantStorageCostSum(c *fiber.Ctx) error {
...
func GetTenantIngressCostSum(c *fiber.Ctx) error {
